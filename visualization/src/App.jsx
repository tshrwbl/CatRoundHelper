...
function Explorer({ rows, loading, onSelectTrend, onOpenCollege, pagination, sort, onSort, percentiles, exam }) {
  ...
  return <><div className="table-wrap"><table>
    <thead><tr>{heading('College / branch', 'collegeName')}{exam !== 'JEE' && heading('Category', 'category')}{heading('CET 2024', 'cet2024')}{heading('JEE 2024', 'jee2024')}{heading(`3-year ${exam} change`, changeKey)}<th /></tr></thead>
